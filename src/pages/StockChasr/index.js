...
function PhotoGallery() {
    return (
        <div id="pageContent">
            ...
            <div id="buttons">
            <a href="https://github.com/adamalcantara/stockchasr" className="button" target="_blank">Project Repository</a>
            <a href="https://stockchasr.herokuapp.com/" className="button" target="_blank">Deployed Project</a>
            </div>
        </div>
    )
}
