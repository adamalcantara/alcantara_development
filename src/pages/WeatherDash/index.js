...
function WeatherDash() {
    return (
        <div id="pageContent">
            ...
            <a href="https://github.com/adamalcantara/weather_dashboard" className="button">Project Repository</a>
            <a href="https://adamalcantara.github.io/weather_dashboard/" className="button">Deployed Project</a>
        </div>
    )
}
