...
function CodeQuiz() {
    return (
        <div id="pageContent">
            ...
            <div id="buttons">
            <a href="https://github.com/adamalcantara/code_quiz" className="button" target="_blank">Project Repository</a>
            <a href="https://adamalcantara.github.io/code_quiz/" className="button" target="_blank">Deployed Project</a>
            </div>
        </div>
    )
}
