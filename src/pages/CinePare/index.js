...
function CinePare() {
    return (
        <div id="pageContent">
            ...
            <div id="buttons">
            <a href="https://github.com/adamalcantara/cinepare" className="button" target="_blank">Project Repository</a>
            <a href="https://adamalcantara.github.io/cinepare/" className="button" target="_blank">Deployed Project</a>
            </div>
        </div>
    )
}
